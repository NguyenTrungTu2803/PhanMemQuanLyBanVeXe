	...
	Create Table Xe7Cho
	(
		IdSoGhe int not null,
		So1 int not null, So2 int not null, So3 int not null, So4 int not null, So5 int not null, So6 int not null, Tien int  not null
	)
	GO 
	-------------------------------Tạo Hàm--------------------------------------------------------
...
----------------------------------- Thêm giá trị vào bảng -------------------------------------------
	...
	INSERT INTO dbo.ACCOUNTDAILY VALUES (N'DH004', N'Pha Lê', N'Nguyễn Thụy Pha Lê', N'12345', N'Nữ', N'0369784521', N'Quan_Ly')
...
------------------Goi ham tu dong tang ma thoi diem cho bang thoi diem-------------------------------------------
	...
	go
	INSERT INTO ChuyenXe(IdTuyen, So_Xe, NgayDi, Gio) Values('001', '55Y-7777', '2018/01/12', '5h35')
	INSERT INTO ChuyenXe(IdTuyen, So_Xe, NgayDi, Gio) Values('002', '53Y-7788', '2018/01/14', '8h30')
	INSERT INTO ChuyenXe(IdTuyen, So_Xe, NgayDi, Gio) Values('003', '50S-2934', '2018/01/13', '15h')
	INSERT INTO ChuyenXe(IdTuyen, So_Xe, NgayDi, Gio) Values('009', '52N-3333', '2018/01/14', '13h')
	INSERT INTO ChuyenXe(IdTuyen, So_Xe, NgayDi, Gio) Values('005', '54H-1234', '2018/01/14', '6h')
	INSERT INTO ChuyenXe(IdTuyen, So_Xe, NgayDi, Gio) Values('004', '54H-1234', '2018/01/12', '5h35')
	Select * from ChuyenXe

	ALTER TABLE BanVe ADD CONSTRAINT def_BanVe DEFAULT dbo.AddmasoVe('VE') FOR IdVe
	go
	Insert into BanVe(IdChuyen, TenHanhKhach, SDTHanhKhach) Values('CX0001', N'Nguyen Van A', '091843256')
	Insert into BanVe(IdChuyen, TenHanhKhach, SDTHanhKhach) Values('CX0001', N'Hoàng Văn B', '091843256')
	Insert into BanVe(IdChuyen, TenHanhKhach, SDTHanhKhach) Values('CX0001', N'Nguyễn Văn C', '090276189')
	Insert into BanVe(IdChuyen, TenHanhKhach, SDTHanhKhach) Values('CX0001', N'Nguyễn Thị Thanh Lan', '091847916')

	Insert Into ChoNgoi Values('CX0002', '55Y-7777', '1')
	Insert Into ChoNgoi Values('CX0001', '55Y-7777', '5')
	Insert Into ChoNgoi Values('CX0003', '55Y-7777', '8')
	Insert Into ChoNgoi Values('CX0001', '55Y-7777', '15')

	INSERT INTO Xe7Cho values('001','0', '0', '0', '0', '0', '0', '0')
	Select *from Xe7Cho
-----------------------------------------------------------------------------------------------------------------------------------
	--Select * from ACCOUNTDAILY
	--Select So_Cho_Ngoi from Xe Where So_Xe = '54H-1234'
	--Delete from dbo.Xe Where So_Cho_Ngoi = 25; 
	--Select *from dbo.PhanQuyen
	--Delete ChiTietTuyen from ThoiDiem, ChiTietTuyen Where ChiTietTuyen.IdThoiDiem = ThoiDiem.IdThoiDiem  and ThoiDiem.IdThoiDiem = 'TD0007'
	...
	--Select TuyenXe.IdTuyen, ChiTietTuyen.IdThoiDiem, ThoiDiem.Ngay, ThoiDiem.Gio, TuyenXe.TenTuyen 
	--From TuyenXe Join ChiTietTuyen on (TuyenXe.IdTuyen = ChiTietTuyen.IdTuyen) 
	--Join ThoiDiem on (ThoiDiem.IdThoiDiem = ChiTietTuyen.IdThoiDiem)	
	--Update ChuyenXe Set ChuyenXe.IdTuyen = N'007', NgayDi = '2018/02/14', Gio = N'6h', So_Xe = N'50S-2934' Where IdChuyen = N'CX0001'
	--Update Xe Set So_Xe = N'53H-1234' Where So_Xe = N'54H-1234'
	--Select BanVe.IdVe, BanVe.TenHanhKhach, BanVe.SDTHanhKhach, TuyenXe.TenTuyen, ChuyenXe.NgayDi, ChuyenXe.Gio, Xe.So_Xe, Xe7Cho.So1 From ChuyenXe
	--	Join BanVe on (BanVe.IdChuyen = ChuyenXe.IdChuyen) 
	--	Join TuyenXe on (ChuyenXe.IdTuyen = TuyenXe.IdTuyen) 
	--	Join Xe on (Xe.So_Xe = ChuyenXe.So_Xe)
		
	--Select Xe.So_Xe, Xe.Hieu_Xe, Xe.Doi_Xe, Xe.So_Cho_Ngoi From Xe Join ChoNgoi on (Xe.So_Xe = ChoNgoi.So_Xe)
	--Select TuyenXe.TenTuyen, ChuyenXe.NgayDi, ChuyenXe.Gio, ChuyenXe.So_Xe From ChuyenXe Join TuyenXe on (TuyenXe.IdTuyen = ChuyenXe.IdTuyen)
